...
def parse_from_case(JobShop, data, number_total_jobs, number_total_machines):
    ...
    for key, line in enumerate(data):
        if key == 0:
            continue
        if key > number_total_jobs: # first line is number of J and M in the cases generated by case_generator of FJSP
            break
        # print('data', key, line)
        # Split data with multiple spaces as separator
        parsed_line = re.findall('\S+', line)
